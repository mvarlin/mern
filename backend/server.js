...
dotenv.config();
console.log('ICI : ', `mongodb://${process.env.DB_USER}:${process.env.PASSWORD}@${process.env.HOST}:${process.env.MONGO_PORT}/mern`);
...
// mongoose
//   .connect(
//     `mongodb://mattise:linkedin@localhost:27017/mern`,
//     {
//       useNewUrlParser: true,
//       useUnifiedTopology: true,
//       useCreateIndex: true
